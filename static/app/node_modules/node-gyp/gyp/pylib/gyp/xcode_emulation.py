...
class XcodeSettings(object):
  ...
  def GetWrapperExtension(self):
    """Returns the bundle extension (.project, .framework, .plugin, etc).  Only
    valid for bundles."""
    assert self._IsBundle()
    if self.spec['type'] in ('loadable_module', 'shared_library'):
      ...
      if self._IsIosAppExtension() or self._IsIosWatchKitExtension():
        ...
        return '.' + self.spec.get('product_extension', 'project')
    else:
  ...
  def GetBundleContentsFolderPath(self):
    ...
    Chromium.project/Contents or Foo.bundle/Versions/A. Only valid for bundles."""
    if self.isIOS:
      return self.GetWrapperName()
    assert self._IsBundle()
  ...
  def GetBundleResourceFolder(self):
    ...
    Chromium.project/Contents/Resources. Only valid for bundles."""
    assert self._IsBundle()
    if self.isIOS:
  ...
  def GetBundlePlistPath(self):
    ...
    Chromium.project/Contents/Info.plist. Only valid for bundles."""
    assert self._IsBundle()
  ...
  def GetProductType(self):
    ...
    if self._IsIosAppExtension():
      ...
      return 'com.apple.product-type.project-extension'
  ...
  def _GetBundleBinaryPath(self):
    ...
    E.g. Chromium.project/Contents/MacOS/Chromium. Only valid for bundles."""
    assert self._IsBundle()
  ...
  def GetExecutablePath(self):
    ...
    Chromium.project/Contents/MacOS/Chromium."""
    if self._IsBundle():
